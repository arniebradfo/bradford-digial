...
<GatsbyImageMdx fluidName={'Reporting_Heatmaps-Screenshot-1.png'} Tag={'p'} />

<GatsbyImageMdx fluidName={'Reporting_Heatmaps-Screenshot-2.png'} Tag={'p'} />

<GatsbyImageMdx fluidName={'Reporting_Heatmaps-Screenshot-3.png'} Tag={'p'} />

<GatsbyImageMdx fluidName={'Reporting_Heatmaps-Screenshot-4.png'} Tag={'p'} />
