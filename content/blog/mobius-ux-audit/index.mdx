...
<GatsbyImageMdx fluidName={'Mobius-v7-vs-v8-6-Interaction-States-Old.svg'} Tag={'p'} />

<GatsbyImageMdx fluidName={'Mobius-v7-vs-v8-6-Interaction-States-New.svg'} Tag={'p'} />
...
<GatsbyImageMdx fluidName={'Mobius-v7-vs-v8-2-Toolbars.png'} Tag={'p'} />
...
<GatsbyImageMdx fluidName={'Mobius-v7-vs-v8-1-Floating-UI.png'} Tag={'p'} />
...
<GatsbyImageMdx fluidName={'Mobius-v7-vs-v8-3-New-Feature.png'} Tag={'p'} />
...
<GatsbyImageMdx fluidName={'Mobius-v7-vs-v8-4-Rearranged.png'} Tag={'p'} />
