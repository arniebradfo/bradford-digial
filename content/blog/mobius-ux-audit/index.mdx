...
date: "2018-04-08"
excerpt: "Mobius started out as a very simple piece of software, but as the AGILE process added more features one by one, the app became more cluttered and less coherent. When I was handed the reigns, some aspects the app were in disarray."
featuredImage: "../../ignore-media/Mobius-v8-header.png"
---
...
<GatsbyImageMdx fluidName={'Mobius-v7-vs-v8-6-Interaction-States-Old.svg'} />

<GatsbyImageMdx fluidName={'Mobius-v7-vs-v8-6-Interaction-States-New.svg'} />
...
<GatsbyImageMdx fluidName={'Mobius-v7-vs-v8-2-Toolbars.png'} />
...
<GatsbyImageMdx fluidName={'Mobius-v7-vs-v8-1-Floating-UI.png'} />
...
<GatsbyImageMdx fluidName={'Mobius-v7-vs-v8-3-New-Feature.png'} />
...
<GatsbyImageMdx fluidName={'Mobius-v7-vs-v8-4-Rearranged.png'} />
...
<ImageRow ids={[ 837,853 ]} />

<ImageRow ids={[ 838,854 ]} />

<ImageRow ids={[ 839,855 ]} />

<ImageRow ids={[ 840,856 ]} />

<ImageRow ids={[ 842,857 ]} />

<ImageRow ids={[ 843,858 ]} />

<ImageRow ids={[ 844,859 ]} />

<ImageRow ids={[ 845,860 ]} />

<ImageRow ids={[ 846,861 ]} />
