...
<GatsbyImageMdx fluidName={'AvyMap_prototype-low-qual.gif'} Tag={'p'} />
...
<GatsbyImageMdx fluidName={'AvyMap_Logo.svg'} Tag={'p'} />
...
<GatsbyImageMdx fluidName={'AvyMap_Logo-Vectors-1024x582.png'} Tag={'p'} />
