...
featuredImage: "../../ignore-media/AvyMap_header-2.png"
---
...
import avyMapsMovie from '../../ignore-media/AvyMaps-App-Movie-3.mp4'
...
<GatsbyImageMdx fluidName={'AvyMap_prototype-low-qual.gif'} />
...
<GatsbyImageMdx fluidName={'AvyMap_Logo.svg'} />

<ImageRow ids={[ 1144,1145,1146,1147,1148 ]} />

It's pixel aligned down to a 32px width, so it’s always super crisp at any multiple of 32px.

<GatsbyImageMdx fluidName={'AvyMap_Logo-Vectors-1024x582.png'} />
