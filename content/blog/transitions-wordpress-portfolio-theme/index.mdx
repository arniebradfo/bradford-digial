...
date: "2019-01-08"
description: "I built a wordpress theme to showcase my portfolio. It features a simple, content-first design with smooth page load and unload animations. Everything ‘transitions’ from one state/page to another."
# featuredImage: "../../lfs-media/"
---
...
<GatsbyImageMdx fluidName={'Transitions-Theme-Animation.gif'} />
