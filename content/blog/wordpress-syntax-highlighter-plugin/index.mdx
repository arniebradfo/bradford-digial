...
date: "2019-01-20"
excerpt: "A plug-in has never made me cry but this one has. It is the most amazing, lightweight, and functional plugin I have ever had the honor of using. It is a must use plugin for any one serious about WordPress and frankly should be built in to WordPress"
featuredImage: "../../ignore-media/html-syntax-highlighter-wordpress-plugin_header.jpg"
---
...
<GatsbyImageMdx fluidName={'html-syntax-highlighter-wordpress-plugin_shortcode-no-highlighting.png'} />
...
<GatsbyImageMdx fluidName={'html-syntax-highlighter-wordpress-plugin_shortcode-highlighting.png'} />
...
<GatsbyImageMdx fluidName={'html-syntax-highlighter-wordpress-plugin_settings-animation.gif'} />
...
<GatsbyImageMdx fluidName={'html-syntax-highlighter-wordpress-plugin_theme-change.gif'} />

### Text Display

I added quick options to change the Indentation, Line Wrapping, Line Numbering, Line Height, and Font Size.

<GatsbyImageMdx fluidName={'html-syntax-highlighter-wordpress-plugin_text-settings-fast.gif'} />
...
<GatsbyImageMdx fluidName={'html-syntax-highlighter-wordpress-plugin_find-and-replace.gif'} />
...
<GatsbyImageMdx fluidName={'html-syntax-highlighter-wordpress-plugin_plugin-editor.gif'} />
...
<GatsbyImageMdx fluidName={'html-syntax-highlighter-wordpress-plugin_gutenberg-support.png'} />
...
<GatsbyImageMdx fluidName={'html-syntax-highlighter-wordpress-plugin_gutenberg-no-support.png'} />
...
<GatsbyImageMdx fluidName={'html-syntax-highlighter-wordpress-plugin_monaco-example.png'} />
...
<GatsbyImageMdx fluidName={'html-syntax-highlighter-wordpress-plugin_wp-code-logo-bg.svg'} />
