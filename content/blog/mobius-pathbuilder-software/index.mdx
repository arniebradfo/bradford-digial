...
<GatsbyImageMdx fluidName={'Mobius_Pathbuilder-Steps-01.png'} Tag={'p'} />

Create a drivable path that can be customized to match testing needs and course routes.

## 02: Scriptable Action Planning

<GatsbyImageMdx fluidName={'Mobius_Pathbuilder-Steps-02.png'} Tag={'p'} />
...
<GatsbyImageMdx fluidName={'Mobius_Pathbuilder-Steps-03.png'} Tag={'p'} />
...
<GatsbyImageMdx fluidName={'Mobius_Pathbuilder-Ford-Fusion-with-kit.png'} Tag={'p'} />
...
<GatsbyImageMdx fluidName={'Mobius_Pathbuilder-1.png'} Tag={'p'} />

<GatsbyImageMdx fluidName={'Mobius_Pathbuilder-2.png'} Tag={'p'} />

<GatsbyImageMdx fluidName={'Mobius_Pathbuilder-4.png'} Tag={'p'} />

<GatsbyImageMdx fluidName={'Mobius_Pathbuilder-6.png'} Tag={'p'} />

<GatsbyImageMdx fluidName={'Mobius_Pathbuilder-7.png'} Tag={'p'} />

<GatsbyImageMdx fluidName={'Mobius_Pathbuilder-9.png'} Tag={'p'} />

<GatsbyImageMdx fluidName={'Mobius_Pathbuilder-10.png'} Tag={'p'} />

<GatsbyImageMdx fluidName={'Mobius_Pathbuilder-11.png'} Tag={'p'} />
