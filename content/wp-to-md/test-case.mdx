...
description: This is a custom description for SEO and Open Graph purposes, rather than the default generated description. Simply add a description field to the frontmatter.
# featuredImage: ""
---
...
<MdxGatsbyImage fluidName={'James-Bradford-Travel-Photo-Japan-2.jpg'} Tag={'p'}/>
